    ...
    <IonPage>
      ...
      <IonContent fullscreen>
        ...
        <div className="session-buttons">
          ...
          <IonButton routerLink='/tabs/tab3/session' id ="edit-session" color="coral" className="session-button">Edit session</IonButton>
          <IonButton routerLink='/tabs/tab3/session' id ="start-session" color="coral" className="session-button">Start session</IonButton>
